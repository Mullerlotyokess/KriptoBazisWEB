...
router.post('/profiles', (req, res) =>{
  pool.query(`INSERT INTO profiles VALUES (null, ${req.body.userID}, '${req.body.nickname}', '${req.body.statusmsg}', '${req.body.location}', '${req.body.social}', '${req.body.pfp}')`, (err, results) => {
